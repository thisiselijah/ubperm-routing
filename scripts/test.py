...
def main():
    ...
    parser.add_argument("-algo", type=str, default="bfs", choices=["bfs", "merge", "astar", "entropy_cycle", "beam_search", "stochastic"], help="演算法 (bfs, merge, astar, entropy_cycle, beam_search 或 stochastic)")
